...
import { StockViewTabs, type StockView } from "../stock-view-tabs";
  ...
  const metrics = useMemo(() => {
    ...
    if (isLoading) {
      return [
        ...
        { id: "linked_soti", label: "Vinculados SOTI", value: "...", subtitle: "" },
    ...
    return [
      ...
      },
      {
        ...
        subtitle: "En SOTI sin asignación formal",
      },
      {
        id: "in_transit",
        label: "En envio",
          ...
          contentTrailing={
            <div className="absolute top-5 right-4 md:right-6 flex items-center justify-end gap-3">
              <ButtonUtility
                ...
                disabled={isLoading}
              />
              <StockSyncButton onSyncComplete={refresh} disabled={isLoading} />
            </div>
          }
        />
